...
CACHE = (Path(os.environ["TL_MCP_SESSION"]) / "peer-cohort-cache.json"
         if os.environ.get("TL_MCP_SESSION") else
         Path(__file__).resolve().parent.parent / "references" / "peer-cohort-cache.json")
CACHE_TTL_DAYS = 30
MAX_PEERS = 12
