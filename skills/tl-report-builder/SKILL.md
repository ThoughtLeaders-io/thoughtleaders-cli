...
> - **Default to preview**, then close the reply with one line: *"If you want this saved as a TL report you can come back to, just say save."* — **never** *"saved as a campaign"* (rule 6: "campaign" is Django jargon, not user-facing TL terminology).
